...
- **Banks:** each player starts a game with a 10-minute bank. Every turn also grants a temporary 20-second bonus that is spent first; the bank only ticks down once a turn runs past 20 seconds. When a player passes, the overrun is deducted from their bank.
